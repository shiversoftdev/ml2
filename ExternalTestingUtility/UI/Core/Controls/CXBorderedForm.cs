...
namespace ML2.UI.Core.Controls
{
    ...
    public partial class CXBorderedForm : UserControl, IThemeableControl
    {
        ...
        public CXBorderedForm()
        {
            InitializeComponent();
            MouseDown += MouseDown_Drag;
            MainPanel.MouseDown += MouseDown_Drag;
            UIThemeManager.RegisterCustomThemeHandler(typeof(CXBorderedForm), ApplyThemeCustom_Implementation);
    ...
    internal class CBorderedFormDesigner : ParentControlDesigner
    {
        public override void Initialize(IComponent component)
        {
            ...
            var contentsPanel = ((CXBorderedForm)this.Control).ControlContents;
